...
$messages = App\Message::where([['messagetype', '=', true], ['readstatus', '=', true], ['user_id', '=', Auth::user()->id]])->take(10)->get();
      $messageNo = App\Message::where([['messagetype', '=', true], ['readstatus', '=', true], ['user_id', '=', Auth::user()->id]])->count();
      ?>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('liveChat')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Live Chat</p>
                  </a>
                </li>
